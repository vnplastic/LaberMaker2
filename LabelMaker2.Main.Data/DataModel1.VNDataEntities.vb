...
Namespace VNDataModel
    ...
    Partial Public Class VNDataEntities
        Inherits DbContext
#Region "Constructors"
        ''' <summary>
...
#Region "Methods"
        ...
        Public Overridable Sub InsertNewCartonJobLine(ByVal Reprint As Global.System.Nullable(Of Boolean))
        ...
        Public Overridable Sub InsertNewPalletJob(ByVal Reprint As Global.System.Nullable(Of Boolean))
            Dim connection As EntityConnection = DirectCast(DirectCast(Me, IObjectContextAdapter).ObjectContext.Connection, EntityConnection)
            Dim needClose As Boolean = False
            If (connection.State <> System.Data.ConnectionState.Open) Then
                connection.Open()
        ...
        Public Overridable Sub InsertNewCartonJob(ByVal Reprint As Global.System.Nullable(Of Boolean))
            Dim connection As EntityConnection = DirectCast(DirectCast(Me, IObjectContextAdapter).ObjectContext.Connection, EntityConnection)
            Dim needClose As Boolean = False
            If (connection.State <> System.Data.ConnectionState.Open) Then
                connection.Open()
